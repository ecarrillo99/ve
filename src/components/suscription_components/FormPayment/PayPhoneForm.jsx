...
const PayPhoneForm = () => {
    ...
    const [meses, setMeses]=useState(["01","02","03","04","05","06","07","08","09","10","11","12"]);
        ...
        <div className="w-full">
            <div className="flex flex-wrap gap-y-3 gap-x-3 items-center justify-center sm:flex-col md:flex-row">
                <div className="flex flex-col justify-center">
                    <div className="mb-5">
                        <label for="names" class="block mb-2 text-sm font-medium text-gray-900 ">Nombres del titular</label>
                        <div class="relative">
                            ...
                            <input type="text" id="input-group-1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full ps-10 p-2.5" placeholder="Ingrese nombres del titular" onChange={handleChangeNombres} />
                        </div>
                        <div className="h-2">
                            {
                    ...
                    <div className="mb-5">
                        <label for="names" class="block mb-2 text-sm font-medium text-gray-900 ">Número de tarjeta</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                            <div dangerouslySetInnerHTML={{ __html: tarjetaIcono }} />
                            </div>
                            <input type="text" id="input-group-1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full ps-10 p-2.5" placeholder="Ingrese el número de su tarjeta" onChange={handleChangeTarjeta} value={formatTarjeta(tarjeta)}/>
                        </div>
                        <div className="h-2">
                            {
                    ...
                    <div class="grid gap-x-6 mb-0 md:grid-cols-3">
                        <div>
                            ...
                            <div class="relative mb-6">
                                ...
                                <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ps-10" >
                                    {meses &&
                        ...
                        <div className="mb-5">
                        <label for="names" class="block mb-2 text-sm font-medium text-gray-900 ">CVV</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                                <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16">
                                    <path d="m10.036 8.278 9.258-7.79A1.979 1.979 0 0 0 18 0H2A1.987 1.987 0 0 0 .641.541l9.395 7.737Z" />
                            ...
                            <input type="text" id="input-group-1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full ps-10 p-2.5" placeholder="CVV" onChange={handleChangeCVV} />
                        </div>
                        <div className="h-2">
                            {
                    ...
                    <div className="flex items-center justify-center">
                        <button class=" text-white bg-greenVE-500 rounded-lg text-sm w-20 sm:w-auto px-5 py-2.5 text-center" onClick={() => handleClickContinuar()}>Procesar</button>
                    </div>
