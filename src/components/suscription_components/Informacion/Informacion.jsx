...
const Informacion = ({setOpcion, persona, setPersona, setPago}) => {
    ...
    const handleClickContinuar=()=>{
        ...
        if(!error){
            ...
            if(typePayment==3){
                var pago={
                    IdTipoBotonPago: botonPago==1?"7":"8",
                    botonLogo:botonPago==1?"./img/web/pp_logo.jpg":"./img/web/ja_logo.png",
                    Meses:"1"
                };
        ...
        <div className='flex flex-col bg-gray-200 p-3 rounded-lg'>
            ...
            <div>
                <div className='flex flex-wrap gap-x-4 gap-y-4 justify-center'>
                    <div className={`w-2/5 border ${errorCedula?"border-red-500":"border-gray-300"} bg-white flex  items-center px-3 py-1.5 gap-2`}>
                    ...
                    <div className={`w-2/5 border ${errorNombres?"border-red-500":"border-gray-300"} bg-white flex  items-center px-3 py-1.5 gap-2`}>
                    ...
                    <div className={`w-2/5 border ${errorCelular?"border-red-500":"border-gray-300"} bg-white flex  items-center px-3 py-1.5 gap-2`}>
                    ...
                    <div className={`w-2/5 border ${errorCorreo?"border-red-500":"border-gray-300"} bg-white flex  items-center px-3 py-1.5 gap-2`}>
                    ...
                    <div className={`w-2/5   bg-white flex  items-center   gap-2  border ${errorTipoPago?"border-red-400":""}`}>
                        <Select  
                            value={typePayment}
                            placeholder={
                    ...
                    {
                        typePayment==1 && <div className={`w-2/5   bg-white flex  items-center   gap-2 border ${errorBanco?"border-red-400":""}`}>
                    ...
                    {
                        typePayment==2 && <div className={`w-2/5   bg-white flex  items-center   gap-2 border ${errorTD?"border-red-500":""}`}>
                    ...
                    {
                        typePayment==3 && <div className={`w-2/5   bg-white flex  items-center   gap-2 border ${errorBotonPago?"border-red-500":""}`}>
                            ...
                            <Select  
                                ...
                                <SelectItem value={1}>
                                    <div className='flex gap-1 items-center'>
                                        <img src='./img/web/pp_logo.jpg'  className='w-5 h-5'/>
                                        <label>PayPhone</label>
                                    </div>
                                </SelectItem>
                                <SelectItem value={2}>
                                    <div className='flex gap-1 items-center'>
                                        <img src='./img/web/ja_logo.png'  className='w-5 h-5'/>
                    ...
                    {
                        (banco!=null&&banco!=0)&&<div className={`w-2/5   bg-white flex  items-center   gap-2 border ${errorTC?"border-red-500":""}`}>
                    ...
                    }
                    {
                        ...
                        )&&<div className={`w-2/5   bg-white flex  items-center   gap-2 border ${errorDiferido?"border-red-500":""}`}>
            ...
            <div className='px-16 text-[10px] flex justify-center items-center text-center mt-8'>
                {/*<input 
                    type="checkbox" 
