        ...
        <div className="mt-10 md:mx-0 mx-5">
            ...
            <div className="flex justify-between mb-4">
             ...
             <div className="flex md:flex-wrap md:flex-row flex-col items-center justify-center cursor-pointer">
                <div className="flex flex-col items-center justify-center md:w-1/3 w-[100%] bg-gray-200 border-4 border-white py-2.5" onClick={()=>onClickReward("municipios")}>
                ...
                <div className="flex flex-col items-center justify-center md:w-1/3 w-[100%] bg-gray-200 border-4 border-white py-2.5 cursor-pointer" onClick={()=>onClickReward("ministerios")}>
                ...
                <div className="flex flex-col items-center justify-center md:w-1/3 w-[100%] bg-gray-200 border-4 border-white py-2.5 cursor-pointer" onClick={()=>onClickReward("entidades")}>
