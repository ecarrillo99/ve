...
const LoginNormal = () => {
    ...
    return (
        <>
            <ResetPassword isOpen={openReset} handleClickCloseReset={handleClickCloseReset}></ResetPassword>
            <div className="flex flex-col items-center justify-center gap-4 ">
                ...
                <button onClick={() => handleClickReset()} className="  py-1 rounded-md text-greenVE-500 w-3/4 md:w-1/2  text-right -m-2 text-sm">Olvidé mi contraseña</button>
                <button className="bg-greenVE-500 px-4 py-1 rounded-md text-white w-3/4 md:w-1/2 w-1/2 flex justify-center" onClick={() => handleClickLogin()}>
                    {
                        isLoading
