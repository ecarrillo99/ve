        ...
        <div className="flex gap-3">
          <div onClick={() => handleClickProfile()}>
            {nivel === "visitante" || foto === "" ? (
              ...
              <img
                src={foto}
                className="rounded-full h-8 w-8 border-2  block"
              />
            )}
          </div>
      ...
      {openMenu ? (
        <div className=" fixed  z-50 w-full right-0 top-0 bg-white h-full">
          <div
            ...
            className="flex items-center justify-end pr-4 pt-2 text-3xl"
          >
            x
          </div>
          <div className="px-6 pt-4 flex flex-col gap-6 justify-start items-start">
            {(nivel === "visitante" || nivel === "gratuito") && (
              <div
                className="bg-greenVE-500 flex flex-col items-center justify-center rounded-xl w-full cursor-pointer"
                onClick={() => setOpenConvenios(!openConvenios)}
              >
                <div className="flex items-center">
                  <label className="px-4 py-1 w-full text-center items-center gap-2  text-white -mr-4 cursor-pointer">
                ...
                {!openConvenios ? (
                  ...
                  <div className="flex flex-col gap-2 pb-2 w-full px-2">
                    <label className="px-4 text-sm py-1 w-full text-center items-center gap-2  text-white -mt-2 cursor-pointer">
                      Continuar con...
                    </label>
                    <div
                      className="rounded-full bg-white p-1 flex items-center w-full"
                      onClick={(event) => {
                        window.open("/convenio/bda", "_self");
                      }}
                    >
                      <img
                        src="https://visitaecuador.com/img/web/ba_logo.jpg"
                        className="h-7 w-7 pl-1"
                      />
                      <label className="px-1  py-1  text-left items-center cursor-pointer">
                        Banco del Austro
                      </label>
                    </div>
                    <div
                      className="rounded-full bg-white p-1 flex w-full items-center"
                      onClick={(event) => {
                        window.open("/convenio/cja", "_self");
                      }}
                    >
                      <img
                        src="https://visitaecuador.com/img/web/ja_logo.png"
                        className="h-6 w-7 pl-1 object-contain"
                      />
                      <label className="px-1  py-1 text-left items-center gap-2 cursor-pointer">
                        Coop. Jardín Azuayo
                      </label>
                    </div>
                    <div
                      className="rounded-full bg-white p-1 flex w-full items-center"
                      onClick={(event) => {
                        window.open("/convenio/cpn", "_self");
                      }}
                    >
                      <img
                        src="https://visitaecuador.com/img/web/cpn_logo.jpg"
                        className="h-7 w-7 pl-1"
                      />
                      <label className="px-1 py-1 text-left items-center gap-2 cursor-pointer">
                    ...
                    <div
                      className="rounded-full bg-white p-1 flex w-full items-center"
                      onClick={(event) => {
                        window.open("/convenio/pp", "_self");
                      }}
                    >
                      <img
                        src="https://visitaecuador.com/img/web/pp_logo.png"
                        className="h-7 w-7 pl-2 object-contain "
                      />
                      <label className="px-1 py-1 w-[145px] text-left items-center gap-2 cursor-pointer">
                        PayPhone
                      </label>
                    </div>
                    <div
                      className="rounded-full bg-white p-1 flex w-full items-center"
                      onClick={(event) => {
                        window.open("/convenio/bp", "_self");
                      }}
                    >
                      <img
                        src="https://visitaecuador.com/img/web/bp_logo.png"
                        className="h-8 w-8 pl-1 object-contain"
                      />
                      <label className="px-1 py-1 w-[145px] text-left items-center gap-2 cursor-pointer">
                        Banco Pichincha
                      </label>
            ...
            {(nivel === "visitante" || nivel === "gratuito") && (
              <div onClick={handleClickSuscription} className="flex gap-2">
                <svg
                  ...
                  fill="none"
                  viewBox="0 0 14 14"
                  id="Shopping-Cart-2--Streamline-Flex"
                >
                  <desc>
                  ...
                  <g id="shopping-cart-2--shopping-cart-checkout">
                    <path
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      d="M13.2025 3.50475c-0.1208 1.27773 -0.4527 2.36809 -0.7668 3.12459 -0.2443 0.5883 -0.7576 1.00296 -1.3828 1.12534 -0.6405 0.12539 -1.61126 0.25118 -2.9279 0.25118 -0.92651 0 -1.711 -0.06229 -2.33829 -0.1429C4.68254 7.72107 3.9039 6.81795 3.7263 5.71895l-0.51927 -3.21309H12.25c0.5523 0 1.0045 0.44906 0.9525 0.99889Z"
                      stroke-width="1"
                    ></path>
                    <path
                      id="Vector_2"
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      d="M11.75 10.5059H6.2018c-0.981 0 -1.81718 -0.71155 -1.97421 -1.6799l-0.95518 -5.89028c-0.15703 -0.96835 -0.99322 -1.67986 -1.97421 -1.67986H0.75"
                      stroke-width="1"
                    ></path>
                    <path
                      id="Vector_3"
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      d="M5.10352 12.7441c0.61808 0 1.11914 -0.501 1.11914 -1.1191s-0.50106 -1.1191 -1.11914 -1.1191c-0.61809 0 -1.11914 0.501 -1.11914 1.1191s0.50105 1.1191 1.11914 1.1191Z"
                      stroke-width="1"
                    ></path>
                    <path
                      id="Vector_4"
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      d="M11.75 12.7441c0.6181 0 1.1191 -0.501 1.1191 -1.1191s-0.501 -1.1191 -1.1191 -1.1191 -1.1191 0.501 -1.1191 1.1191 0.501 1.1191 1.1191 1.1191Z"
                      stroke-width="1"
                    ></path>
                  </g>
                </svg>
                ...
                >
                  ...
                  <g id="gift-2--reward-box-social-present-gift-media-rating-bow">
                    <path
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      d="M4.11 12.94a40.16 40.16 0 0 0 2.89 0.09c1.078 0 2.031 -0.03 2.89 -0.091a2.59 2.59 0 0 0 2.39 -2.391c0.05 -0.622 0.08 -1.255 0.08 -1.903 0 -0.647 -0.03 -1.28 -0.08 -1.902a2.59 2.59 0 0 0 -2.39 -2.391A40.155 40.155 0 0 0 7 4.261c-1.078 0 -2.031 0.03 -2.89 0.092a2.59 2.59 0 0 0 -2.39 2.39 23.47 23.47 0 0 0 -0.08 1.903c0 0.648 0.03 1.281 0.08 1.903a2.59 2.59 0 0 0 2.39 2.39Z"
                      stroke-width="1"
                    ></path>
                    <path
                      id="Vector 312"
                    ...
                    <path
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      d="m7 4.243 1.521 -2.448c0.654 -1.052 2.213 -1 2.796 0.092 0.425 0.798 0.1 1.787 -0.719 2.183L10 4.36"
                      stroke-width="1"
                    ></path>
                    <path
                      id="Vector 520"
                      ...
                      stroke-linecap="round"
                      stroke-linejoin="round"
                      d="M7 4.243 5.479 1.795c-0.654 -1.052 -2.213 -1 -2.796 0.092 -0.425 0.798 -0.1 1.787 0.718 2.183L4 4.36"
                      stroke-width="1"
                    ></path>
                  </g>
                </svg>
              ...
              >
                ...
                <g id="building-2--real-home-tower-building-house-estate">
                  <path
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    d="M8.5 13.5h-8V4l4 -3.5 4 3.5v9.5Z"
                    stroke-width="1"
                  ></path>
                  <path
                    id="Vector_2"
          ...
          <div className=" flex flex-col px-4 gap-6">
            <div className="flex gap-2 items-center cursor-pointer hover:bg-white hover:bg-opacity-20 hover:rounded-md p-1">
              ...
              <div className="flex flex-col ">
                ...
                <label className="capitalize text-xs text-greenVE-600 cursor-pointer">
                  {nivel}
                </label>
              </div>
            </div>
            ...
            <button
              className="py-1 w-full text-start flex items-center gap-2"
              onClick={handleClickAdministrador}
            >
              <div
                dangerouslySetInnerHTML={{ __html: icons.Data.Administrador }}
              />{" "}
              Administrador
              {isLoadingAdmin && (
