    ...
    <footer className="bg-footerColor mt-20 md:px-0 px-5">
      <div className="mx-auto max-w-6xl py-10 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap justify-center md:gap-4 mt-20 gap-3 ">
          ...
          <a className="bg-greenVE-500 w-6 h-6 rounded-full flex items-center justify-center" href="https://www.tiktok.com/@visitaecuador.com" target="_blank"><span className="icon-[ph--tiktok-logo] text-white h-4 w-4"></span></a>
          <a className="bg-greenVE-500 w-6 h-6 rounded-full flex items-center justify-center" href="https://www.youtube.com/@VisitaEcuador-com" target="_blank"><span className="icon-[ph--youtube-logo-bold] text-white h-4 w-4"></span></a>
          <a className="bg-greenVE-500 w-6 h-6 rounded-full flex items-center justify-center" href="https://www.linkedin.com/in/visita-ecuador-44411353" target="_blank"><span className="icon-[uil--linkedin-alt] h-4 w-4 text-white"></span></a>
          <a className="bg-greenVE-500 w-6 h-6 rounded-full flex items-center justify-center" href="https://x.com/clubvisita" target="_blank"><span className="icon-[flowbite--x-company-solid] text-white h-3 w-3"></span></a>
        </div>
