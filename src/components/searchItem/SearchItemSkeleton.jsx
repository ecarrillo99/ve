...
const SearchItemSkeleton = () => {
  return (
    <div className="flex border border-gray-200 border-1 h-60 mb-3 rounded-md shadow-md animate-pulse">
      <div class="w-4/12 bg-gray-300 rounded-l-md">
          ...
          <div className="flex pt- items-center">
            ...
            <div className="w-full flex justify-end items-end">
              <div className="flex flex-col items-center">
                <div class=" bg-gray-300 h-10 w-14 rounded-md font-bold  text-4xl text-center" ></div>
                <div class=" bg-gray-300 h-4 rounded-lg w-16 my-1  text-sm text-center" ></div>
