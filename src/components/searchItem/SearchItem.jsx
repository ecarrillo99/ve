...
const handleSearch = () => {
  ...
  return (
    <div className="flex border border-gray-200 border-1 h-56 mb-3 rounded-md shadow-md ">
      <div class="w-4/12">
        <img src="https://media-cdn.tripadvisor.com/media/photo-s/1d/58/37/0f/caption.jpg" alt="Mi Imagen" class="w-full h-full object-cover rounded-l-md" />
      </div>
      <div class="w-8/12 pl-5 flex items-center">
        <div>
          <div className="flex">
            <h2 className="text-greenVE-600 w-4/5 font-semibold">Villa Ana María</h2>
            <div className="flex items-center">
              <h2 className="text-white bg-feriadosColor rounded-full px-3 text-xs">Feriados</h2>
            </div>
          </div>
          <div className="flex">
          ...
          <div class="flex items-center">
            ...
            <p class=" text-blueLight text-xs" >Cuenca</p>
          </div>
          <div>
            <h2 className="text-block w-4/5 font-semibold">En feriado de octubre con tus amigos con tus amigos o familia visita villa Ana María</h2>
          </div>
          <div className="flex pt-3">
            <div className="w-3/4">
              <div className="flex items-center">
                ...
                <p class=" text-black text-xs pl-1" >2 días</p>
              </div>
              <div className="flex items-center">
                ...
                <p class=" text-black text-xs pl-1" >1 noche</p>
              </div>
              <div className="flex items-center">
            ...
            <div className="pl-4 w-3/4">
              <div className="flex items-center">
                ...
                <p class=" text-black text-xs pl-1" >1 Adulto</p>
              </div>
              <div className="flex items-center">
                ...
                <p class=" text-black text-xs pl-1" >0 niños</p>
              </div>
              <div className="flex items-center">
            ...
            <div className="w-full flex justify-end items-end pr-6">
              <div>
                <p class=" text-greenVE-600 font-bold  text-4xl text-center" >$42</p>
                <p class=" text-red-500  text-sm text-center" >Ahorra 30%</p>
                <button className="bg-greenVE-500 text-white px-2 rounded-xl text-sm" onClick={handleSearch}>Ver Oferta</button>
              </div>
            </div>
          </div>
        </div>
