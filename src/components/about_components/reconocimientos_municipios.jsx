...
const ReconocimientosMunicipio=()=>{
    ...
    return(
        <div>
            <h1 className="text-2xl font-semibold text-[#006b68]">Reconocimientos Municipios</h1>
            <div className="flex flex-col w-full">
                <div className="flex pt-10 gap-x-4">
                    <div className="w-1/3 flex flex-col items-center">
                        ...
                        />
                        <label className="text-[#006b68] font-semibold pt-2">Municipio de Manta</label>
                    ...
                    <div className="w-1/3 flex flex-col items-center">
                        ...
                        />
                        <label className="text-[#006b68] font-semibold pt-2">Municipio de Gualaceo</label>
                        <label className="text-sm text-center">Embajador social media de turismo infoTour</label>
                    </div>
                    <div className="w-1/3 flex flex-col items-center">
                        <Icon
                        ...
                        />
                        <label className="text-[#006b68] font-semibold pt-2">Municipio de Chordeleg</label>
                ...
                <div className="flex pt-10 gap-x-4">
                    ...
                    <div className="w-1/3 flex flex-col items-center">
                        ...
                        />
                        <label className="text-[#006b68] font-semibold pt-2">Municipio de Ibarra</label>
                        <label className="text-sm text-center">Reconocimiento por fomentar el Turismo en el Cantón(2009)</label>
                    </div>
                    <div className="w-1/3 flex flex-col items-center">
                        <Icon
                        ...
                        />
                        <label className="text-[#006b68] font-semibold pt-2">HCP Guayas</label>
