...
const SuperIntendencia = () => {
    ...
    return (
        <div>
            <h1 className="text-2xl font-bold text-[#d0d0d0]">Super Intendencia de Bancos</h1>
                ...
                <div className="flex pt-10 gap-x-4">
                    <div className="w-1/3 flex flex-col items-center">
                        <Icon
                            ...
                            link={"https://visitaecuador.com/nosotros/dg.php?f=https//www.visitaecuador.com/ve/img/contenido/informacion/certificado/superbancos-julio2021.dif"}
                        />
                        <label className="text-sm text-center">Certificación <br/>
                            Julio 2021</label>
                    </div>
                </div>
            </div>
