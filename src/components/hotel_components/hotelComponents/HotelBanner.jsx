const HotelBanner = () => {
    return (
        <div>
            <h1 className="text-2xl font-semibold">Villa Ana María</h1>
            <div className="flex">
            ...
            <div class="flex items-center">
                ...
                <p class="text-base text-blueLight " >Cuenca</p>
            </div>
            <h2 className="text-xl font-semibold">En feriado de octubre con tus amigos o familiares en Villa Ana María</h2>
        </div>
    );
}
